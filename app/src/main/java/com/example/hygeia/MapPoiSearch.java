...
import com.example.hygeia.overlay.PoiOverlay;
...
public class MapPoiSearch extends FragmentActivity implements
...
//                    .findFragmentById(R.id.map)).getMap();
    ...
    private void showSuggestCity(List<SuggestionCity> cities) {
        ...
        ToastUtil.show(MapPoiSearch.this, infomation);
            ...
            if (result != null && result.getQuery() != null) {// 搜索poi的结果
                if (result.getQuery().equals(query)) {// 是否是同一条
                    ...
                    if (poiItems != null && poiItems.size() > 0) {
                        ...
                        ToastUtil.show(MapPoiSearch.this,
                                R.string.no_result);
                    }
                }
            } else {
